package magmaout.mappet.client.gui.scripts;

import magmaout.mappet.client.gui.scripts.utils.documentation.*;
...
public class GuiDocumentationOverlayPanel extends GuiOverlayPanel {
    ...
    private static void parseDocs() {
        ...
        if (dev || docs == null) {
            ...
            topPackage.doc = docs.getPackage("magmaout.mappet.api.scripts.user.mappet").doc;
            scripting.name = "Scripting API";
            scripting.doc = docs.getPackage("magmaout.mappet.api.scripts.user").doc;
            scripting.parent = topPackage;

            ui.name = "UI API";
            ui.doc = docs.getPackage("magmaout.mappet.api.ui.components").doc;
            ...
            if (useNewStructure) {
                ...
                entities.doc = docs.getPackage("magmaout.mappet.api.scripts.user.entities").doc;
                entities.parent = scripting;
                scripting.entries.add(entities);

                nbt.name = "/ NBT";
                nbt.doc = docs.getPackage("magmaout.mappet.api.scripts.user.nbt").doc;
                nbt.parent = scripting;
                scripting.entries.add(nbt);

                items.name = "/ Items";
                items.doc = docs.getPackage("magmaout.mappet.api.scripts.user.items").doc;
                items.parent = scripting;
                scripting.entries.add(items);

                blocks.name = "/ Blocks";
                blocks.doc = docs.getPackage("magmaout.mappet.api.scripts.user.blocks").doc;
