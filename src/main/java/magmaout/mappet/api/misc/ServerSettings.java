package magmaout.mappet.api.misc;

import magmaout.mappet.Mappet;
import magmaout.mappet.api.misc.hotkeys.TriggerHotkeys;
import magmaout.mappet.api.triggers.Trigger;
import magmaout.mappet.events.RegisterServerTriggerEvent;
...
public class ServerSettings implements INBTSerializable<NBTTagCompound> {
    ...
    public final Trigger playerMouse;
    ...
    public ServerSettings(File file) {
        ...
        this.playerKeyboard = this.register("player_keyboard", "keyboard", new Trigger());
        this.playerMouse = this.register("player_mouse", "mouse", new Trigger());
