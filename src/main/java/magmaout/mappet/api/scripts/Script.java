...
import magmaout.mappet.utils.Utils;
import magmaout.mappet.api.scripts.code.ScriptEvent;
import magmaout.mappet.api.scripts.code.ScriptFactory;
import magmaout.mappet.api.utils.AbstractData;
import magmaout.mappet.api.utils.DataContext;
import magmaout.mappet.events.RegisterScriptVariablesEvent;
...
public class Script extends AbstractData {
    ...
    private String DEFAULT_KOTLIN_IMPORTS =
            "import magmaout.remetamorph.api.morphs.AbstractMorph" + "\n" +
                    ...
                    "import magmaout.mappet.api.scripts.user.*" + "\n" +
                    "import magmaout.mappet.api.scripts.user.blocks.*" + "\n" +
                    "import magmaout.mappet.api.scripts.user.data.*" + "\n" +
                    "import magmaout.mappet.api.scripts.user.entities.*" + "\n" +
                    "import magmaout.mappet.api.scripts.user.items.*" + "\n" +
                    "import magmaout.mappet.api.scripts.user.mappet.*" + "\n" +
                    "import magmaout.mappet.api.scripts.user.nbt.*" + "\n" +

                    "import magmaout.mappet.api.scripts.code.*" + "\n" +
                    "import magmaout.mappet.api.scripts.code.blocks.*" + "\n" +
                    "import magmaout.mappet.api.scripts.code.entities.*" + "\n" +
                    "import magmaout.mappet.api.scripts.code.items.*" + "\n" +
                    "import magmaout.mappet.api.scripts.code.mappet.*" + "\n" +
                    "import magmaout.mappet.api.scripts.code.nbt.*" + "\n";
