package magmaout.mappet.api.scripts.user;
...
import magmaout.mappet.api.scripts.user.logs.IMappetLogger;
...
public interface IScriptFactory {
    ...
    /**
     * Convert name/code of key to code/name
     */
    ...
    IMappetImage createImage(String path);
